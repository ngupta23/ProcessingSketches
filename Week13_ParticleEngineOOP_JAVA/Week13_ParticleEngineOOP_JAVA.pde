...
void setup(){
  ...
  Emitter emitter = new Emitter(this, new PVector(width/2, 200), 300, 1, new PVector(0.01,-10.2), 1.25, true, "particleImage.jpg",0.00001);  // Added this since we need to pass the PApplet since it is in JAVA mode
