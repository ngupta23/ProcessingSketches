class MutualFund extends Market{
  ...
  MutualFund(String ticker, float initNumStocks, int numPointsHistory){
  ...
  void setMarketOpenCloseTimes(){
    marketOpenTime = getTimeInMinutes(5,0);
    marketCloseTime = getTimeInMinutes(15,30);  
  }
